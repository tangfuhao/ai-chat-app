...
import {
  MODEL_CONFIGS,
  getModelConfigByModelName,
  getDefaultParams,
  type ModelConfigDescriptor,
...
export function Settings({
  ...
  const [currentParams, setCurrentParams] =
    useState<Record<string, any>>(parameters);
  ...
  useEffect(() => {
    ...
    const config = getModelConfigByModelName(selectedProvider, modelName);
